...
6. **Documents are living.** Every state file is a living document. When new learnings arrive, update the document and log the change in the revision history — don't overwrite silently.
